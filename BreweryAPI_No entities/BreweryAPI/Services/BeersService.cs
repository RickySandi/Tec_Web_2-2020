...
namespace BreweryAPI.Services
{
    public class BeersService : IBeersService
    {
        ...
        public BeerModel CreateBeer(int breweryId, BeerModel beer)
        {
            ...
            return _mapper.Map<BeerModel>(_libraryRepository.CreateBeer(_mapper.Map<BeerModel>(beer)));
        }
        ...
        public BeerModel UpdateBeer(int breweryId, int beerId, BeerModel beer)
        {
            GetBeer(breweryId, beerId);
            beer.Id = beerId;
            return _mapper.Map<BeerModel>(_libraryRepository.UpdateBeer(_mapper.Map<BeerModel>(beer)));
        }
        ...
        public IEnumerable<BeerModel> NotSoldBeers( int breweryId)
        {
            validateBrewery(breweryId);
